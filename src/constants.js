...
export const experiences = [
  {
    ...
    desc: "100% client satistfation for the work, Scalable Full-stack Ecommerce website delivered. Implemented Client-Server Architecture with keeping the software design patterns in view",
    skills: [
      "ReactJS",
      "Axios",
      "Redux",
  ...
  {
    id: 1,
    role: "Integration testing and DB ",
  ...
  },
  {
    ...
    desc: "Delivered robust React web apps to micro-startups, including NotForCollege, ERIS Audio, ErisTech. Achieved 100% client satisfaction and high client retention.",
    skills: ["ReactJS", "Redux", "Figma", "HTML", "CSS", "JavaScript"],
  },
...
export const education = [
  {
    ...
    grade: "8.7 CGPA",
    desc: "CourseWork: Mathematics, Computer Architecture, Computer Networks, Data Structures, ComputationalTheory, Software Engineering.",
  ...
  },
  {
    ...
    grade: "%",
    desc: "I completed my class 12 high school education at Sri Chaitanya College where I studied STEM",
    degree: "Intermediate",
  },
  // {
  //   id: 2,
...
export const projects = [
  {
    title: "D-Host",
    description:
      "Scalable Web3 Decentralized Web Hosting Platform with inbuilt Search Engine infrastructure management with real-time monitoring and automated scaling.",
    technologies: [
      "React",
      "Next.js",
    ...
    github: "https://github.com/neekunjchaturvedi/D-Hosting",
  },
  {
    title: "RepayMaster",
    description:
      "Built a Dynamic Streamlit App featuring prediction of loan repayment timelines for overseas education loansincluding detailed analysis and visualization.",
    technologies: [
      "Python",
      "Streamlit",
      "Pandas",
    ...
    link: "https://repaymaster.streamlit.app/",
    github: "https://github.com/neekunjchaturvedi/DataNyx",
  },
  {
    title: "Top-Code(Code Editor)",
    description:
      "Developed a code editor with multi-language support for compiling and running code",
    technologies: ["React JS", "JavaScript", "Monaco Editor", "Chakra UI"],
    link: "https://top-code.netlify.app/",
    github: "https://github.com/neekunjchaturvedi/Topcode",
  },
  {
    title: "Issue Tracker for Enterprises",
    description:
      "Keeps the track of issues of an Enterprise, Admin can assign issues to employees and employees can keep track of their issues and solve them",
    technologies: ["MongoDB", "Express", "React", "Node"],
    github: "https://github.com/neekunjchaturvedi/issue-tracker",
  },
];
